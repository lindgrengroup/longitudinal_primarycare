...
STRATA <- read.table("/well/lindgren/UKBIOBANK/samvida/hormone_ehr/GWAS/strata_filenames.txt")$V1

trait_dat <- lapply(STRATA, function (st_name) {
  read.table(paste0("/well/lindgren/UKBIOBANK/samvida/hormone_ehr/GWAS/traits_for_gwas/",
...
qcd_ids <- lapply(STRATA, function (st_name) {
  ...
  qc_log_file <- paste0("/well/lindgren/UKBIOBANK/samvida/hormone_ehr/GWAS/log_files/",
                        st_name, ".txt")
...
ids_for_gwas <- lapply(STRATA, function (st_name) {
  ...
  write.table(to_write, 
              paste0("/well/lindgren/UKBIOBANK/samvida/hormone_ehr/GWAS/sample_qc/", 
...
write_traits <- lapply(STRATA, function (st_name) {
  ...
  write.table(keep_traits, 
              paste0("/well/lindgren/UKBIOBANK/samvida/hormone_ehr/GWAS/traits_for_gwas/qcd_",
                     st_name, "_cross_sectional.txt"),
              sep = "\t", row.names = F, quote = F)
