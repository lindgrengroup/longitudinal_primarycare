...
#SBATCH -p long
#SBATCH -c 8
#SBATCH -J softclust_BOLT_GWAS_no_FU_adj
#SBATCH -o /well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/highdim_splines/standardised_outcomes/GWAS/BOLT_logs/softclust_BOLT_GWAS_no_FU_adj-%j.out
...
--lmm \
--numThreads=8 \
--statsFile=BOLT_results/${STRATA}_${CLUST}_no_FU_adjustment_assoc_cal.stats.gz \
...
--statsFileBgenSnps=BOLT_results/${STRATA}_${CLUST}_no_FU_adjustment_assoc_imp.stats.gz \
--verboseStats
