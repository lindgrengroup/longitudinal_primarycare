...
--outdir=/well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/2204_models/GWAS/post_GWAS/${STRATA}/k${KI} \
...
--sumstats=/well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/2204_models/GWAS/SAIGE_results/${STRATA}/${STRATA}_k${KI}_final.txt
