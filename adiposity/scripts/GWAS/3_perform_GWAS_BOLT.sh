...
--lmm \
--numThreads=8 \
--statsFile=/well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/GWAS/BOLT_results/${STRATA_NAME}_lmm_intercepts_assoc_cal.stats.gz \
...
--statsFileBgenSnps=/well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/GWAS/BOLT_results/${STRATA_NAME}_lmm_intercepts_assoc_imp.stats.gz \
--verboseStats
