...
--phenoFile=/well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/GWAS/traits_for_gwas/lmm_slopes_${STRATA_NAME}.txt \
--phenoCol=adj_slope \
...
--lmm \
--numThreads=8 \
--statsFile=/well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/GWAS/BOLT_results/${STRATA_NAME}_lmm_assoc_cal.stats.gz \
...
--statsFileBgenSnps=/well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/GWAS/BOLT_results/${STRATA_NAME}_lmm_assoc_imp.stats.gz \
--verboseStats

cat BOLT_results/${STRATA_NAME}_lmm_assoc_cal.stats.gz BOLT_results/${STRATA_NAME}_lmm_assoc_imp.stats.gz > BOLT_results/${STRATA_NAME}_lmm_assoc.stats.gz