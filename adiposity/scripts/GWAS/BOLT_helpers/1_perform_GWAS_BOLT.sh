...
--phenoFile=/well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/gp_only/GWAS/traits_for_gwas/${STRATA}/${PARAMETER}_${STRATA}.txt \
--phenoCol=adj_trait \
--covarFile=/well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/gp_only/GWAS/sample_qc/${STRATA_NAME}_ids_passed_qc.txt \
--qCovarCol=PC{1:21} \
...
--lmm \
--numThreads=8 \
--statsFile=/well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/gp_only/GWAS/BOLT_results/${STRATA}_${PARAMETER}_assoc_cal.stats.gz \
...
--statsFileBgenSnps=/well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/gp_only/GWAS/BOLT_results/${STRATA}_${PARAMETER}_assoc_imp.stats.gz \
--verboseStats
