...
mkdir /well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/GWAS/SAIGE_results/${STRATA}
...
# Phenotype files: in /well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/GWAS/
...
--traitType=binary \
--outputdir=/well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/GWAS/SAIGE_results/ 
