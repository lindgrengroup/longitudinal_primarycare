...
submission_script <- "/well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/gp_only/GWAS/4_extract_dosages.sh"

# PARAMETERS <- c("lmm_intercepts", "lmm_slopes_adj_baseline", "cspline_intercepts")
PARAMETERS <- "lmm_slopes_adj_baseline"
lead_variants <- lapply(PARAMETERS, function (pr) {
  df <- read.table(paste0("/well/lindgren-ukbb/projects/ukbb-11867/samvida/adiposity/gp_only/GWAS/post_GWAS/lead_snps/",
