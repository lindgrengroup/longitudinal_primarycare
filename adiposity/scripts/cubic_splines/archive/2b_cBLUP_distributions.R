...
blup_distrib <- lapply(PHENOTYPES, function (p) {
  ...
  pdf(paste0("/well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/plots/cubic_splines/blups/blup_distrib_not_adj_genetic_PCs_",
             p, ".pdf"))
  print(per_sex)
  dev.off()
  return ()
...
assoc_plots <- lapply(PHENOTYPES, function (p) {
  ...
  pdf(paste0("/well/lindgren/UKBIOBANK/samvida/adiposity/gp_only/plots/cubic_splines/blups/blup_assocns_not_adj_genetic_PCs_",
             p, ".pdf"))
  print(per_sex)
  dev.off()
  return ()
